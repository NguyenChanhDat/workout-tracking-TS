...
//       const PlanUpdated: Plan = await this.updatePlan.execute(PlanInfor);
//       res.status(PlanApiStatus.OK.status);
//       res.send(PlanApiStatus.OK + ' ' + PlanUpdated);
//     } catch (error) {
//       console.log(error);
...
//         'id' in req.query
//           ? await this.getPlan.executeById(Number(req.query.id))
//           : 'Planname' in req.query
//           ? await this.getPlan.executeByPlanname(String(req.query.Planname))
