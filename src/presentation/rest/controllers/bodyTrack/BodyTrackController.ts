...
//       await this.updateBodyTrack.execute(bodyTrackInfo.id, bodyTrackInfo);
//       res
//         .status(BodyTrackApiStatus.OK.status)
//         .send(BodyTrackApiStatus.OK.message);
//     } catch (error) {
...
//     try {
//       const bodyTrackList = await this.getBodyTrack.getAll();
//       res.status(BodyTrackApiStatus.OK.status).send(bodyTrackList);
//     } catch (error) {
//       console.error(error);
//       res
//         .status(BodyTrackApiStatus.INTERNAL_SERVER_ERROR.status)
